'''
BoostingClassifierMethodsBase - Base class for Machine Gnostics Boosting Classification Methods

This class serves as the foundational base for Gnostic Boosting Classifier.
...
class BoostingClassifierMethodsBase(ModelBase):
    """
    Base class for Machine Gnostics Boosting Classification Methods.
    """
    def __init__(self,
        ...
        if xgb is None:
            self.logger.warning("XGBoost is not installed. GnosticBoostingClassifier will fail at runtime.")
    ...
    def _predict_proba_boosting_impl(self, X: np.ndarray, model: Any) -> np.ndarray:
        """
        Implementation of Boosting probability prediction.
        """
