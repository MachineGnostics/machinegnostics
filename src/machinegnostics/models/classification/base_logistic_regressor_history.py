...
import numpy as np
from machinegnostics.models.classification.base_logistic_regressor_cal import LogisticRegressorCalBase

class HistoryLogisticRegressorBase(LogisticRegressorCalBase):
    """
    History class for the Logistic Regressor model.
