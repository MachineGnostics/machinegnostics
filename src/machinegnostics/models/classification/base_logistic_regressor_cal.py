...
class LogisticRegressorCalBase(RegressorMethodsBase):
    """
        ...
        for self._iter in range(self.max_iter):
            ...
            try:
                ...
                if self._iter > 0 and self.early_stopping:
                    ...
                    log_loss_converged = prev_log_loss_val is not None and np.abs(curr_log_loss - prev_log_loss_val) < self.tolerance
